...
echo "$($PSQL "SELECT name FROM teams INNER JOIN games AS g ON teams.team_id IN (g.winner_id, g.opponent_id) WHERE year = 2014 AND round = 'Eighth-Final' ORDER BY name")"
